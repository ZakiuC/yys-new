...
def main(page: ft.Page):
    ...
    def on_convert(e):
        try:
            ...
            name = save_img_to_json(x, y, img_path, out_dir)
    ...
    page.add(coordinate_row, img_input, out_dir_input, desc_input, template_json_path_input, convert_button, message_text)
